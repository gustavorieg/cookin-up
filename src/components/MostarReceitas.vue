...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita) => {
      ...
      // Todos os ingredientesd e uma receuta deven estar inclusos na minha lista de ingredientes
      // Se sim, devemos retornar 'true'

      const possoFazerReiceta = itensDeLista1EstaoEmLista2(receita.ingredientes, this.ingredientes);

      return possoFazerReiceta;
    })
  },
